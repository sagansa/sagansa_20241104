...
class CreateStoreConsumptionPage extends StatefulWidget {
  final StoreConsumptionModel? consumption;

  const CreateStoreConsumptionPage({super.key, this.consumption});

  @override
  State<CreateStoreConsumptionPage> createState() =>
      _CreateStoreConsumptionPageState();
}

class _CreateStoreConsumptionPageState
    extends State<CreateStoreConsumptionPage> {
  ...
  Future<void> _submitReport() async {
    ...
    // Setidaknya satu item dengan quantity > 0
    ...
    try {
      ...
      if (isEditing) {
        await _service.updateStoreConsumption(
        ...
        await _service.createStoreConsumption(
          _selectedStore!.id,
          dateStr,
          itemsApi,
        );
      ...
      showSuccessSnackBar(
        context,
        isEditing
            ? 'Konsumsi toko berhasil diperbarui.'
            : 'Konsumsi toko berhasil disimpan.',
      );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(isEditing ? 'Edit Konsumsi Toko' : 'Konsumsi Toko Baru'),
      ),
      body: _isLoadingData
                          ...
                          child: ListView(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Text(
                                  'Isi kuantitas konsumsi bahan toko',
                                  style: textTheme.bodySmall?.copyWith(
