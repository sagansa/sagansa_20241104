...
class GlassContainer extends StatelessWidget {
  ...
  const GlassContainer({
    ...
    this.blurSigma = 18,
    this.opacity = 0.78,
    this.borderRadius = const BorderRadius.vertical(top: Radius.circular(AppSpacing.radiusLG)),
    this.borderColor,
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveBg = backgroundColor ?? colorScheme.surface.withValues(alpha: opacity);
